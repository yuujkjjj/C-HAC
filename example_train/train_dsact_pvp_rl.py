...
if __name__ == "__main__":
    ...
    parser.add_argument("--alpha_learning_rate", type=float, default=0.0005)
    # special parameter
    ...
    parser.add_argument(
        ...
        type=str,
        # default=None,#fixed1
        default="/home/carla/LZQW/DSAC-T-EGPO-V2/results/DSAC_V2_PVP_RL_gym_metadrivepvp/new_fixed_3/apprfunc/apprfunc_66000.pkl"
    ...
    parser.add_argument("--max_iteration", type=int, default=1400000)
    ...
    parser.add_argument("--buffer_path", type=str, default= "/home/carla/LZQW/DSAC-T-EGPO-V2/results/DSAC_V2_PVP_RL_gym_metadrivepvp/new_fixed_3/buf_50000.pkl")
    parser.add_argument("--human_buffer_path", type=str, default= "/home/carla/LZQW/DSAC-T-EGPO-V2/results/DSAC_V2_PVP_RL_gym_metadrivepvp/new_fixed_3/human_buf_17000.pkl")

    parser.add_argument("--warm_up", type=bool, default= False)
    parser.add_argument("--q_bound", type=float, default= 1)
    parser.add_argument("--warm_up_step", type=int, default= 80000)
    ################################################
